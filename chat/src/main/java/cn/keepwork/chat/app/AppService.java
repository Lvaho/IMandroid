...
import cn.keepwork.chat.app.login.model.PCSession;
...
public class AppService implements AppServiceProvider {
     ...
     * <br>
     */
    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "http://110.40.190.110:8888";
