...
package cn.keepwork.chat.app.main;
...
public class MainActivity extends WfcBaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initView() {
        ...
        AppService.Instance().changeName("在线"+time, new SimpleCallback<Void>() {
            @Override
            public void onUiSuccess(Void aVoid) {
                Toast.makeText(MainActivity.this,"在线状态修改成功",Toast.LENGTH_LONG).show();
            }

            @Override
            public void onUiFailure(int code, String msg) {
                Toast.makeText(MainActivity.this,"在线状态修改失败",Toast.LENGTH_LONG).show();
            }
        });
